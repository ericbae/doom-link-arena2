...
After publishing this repository publicly, add a Deploy to Cloudflare button using your repo URL:
...
For the `doom.ossy.dev` installer product packaging, see [docs/product-packaging.md](./docs/product-packaging.md).
...
`DOOM_KEY` signs private room IDs. Local development falls back to a development key if no secret is set.
